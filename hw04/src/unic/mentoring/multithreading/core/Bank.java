...
public class Bank
{
	...
	public void addCurrency(String code, double valuette) throws BankException
	{
		...
		LOG.info("Currency added: " + code + ":" + valuette);
	}
	...
	protected void addConversion(Currency source, Currency destination, double rate)
	{
		...
		if (conversion == null)
		{
			conversion = new Conversion(source, destination, rate);
			conversions.put(code, conversion);
			
			LOG.info("Conversion added: " + conversion.toString());
		}
	}
